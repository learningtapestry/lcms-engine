...
(function () {
  var heapEnabled = typeof heap !== 'undefined' && typeof heap.track === 'function';
  ...
  var catchHovers = function catchHovers() {
    var hovered = {},
      node,
      text;
    return function (e) {
  ...
  var catchSelection = function catchSelection() {
    var x;
    return _.debounce(function () {
      x = document.getSelection().toString();

      if (x && x.length) {
        heap.track('Select Text', {
          size: x.length,
          text: x.substring(0, 100)
        });
      }
    }, 500, {
      leading: false
  ...
  var initScrollCatching = function initScrollCatching() {
