...
describe Lcms::Engine::Admin::ResourcesController do
  ...
  describe '#edit' do
    subject { get :edit, id: resource.to_param }
  ...
  describe '#update' do
    ...
    subject { post :update, id: resource.to_param, resource: params }
    ...
    context 'with invalid params' do
      before { allow_any_instance_of(Lcms::Engine::Resource).to receive(:update_attributes).and_return(false) }
