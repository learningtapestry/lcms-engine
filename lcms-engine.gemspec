...
Gem::Specification.new do |s|
  ...
  s.add_dependency 'elasticsearch-dsl', '~> 0.1.5'
  s.add_dependency 'elasticsearch-model', '~> 5.0', '>= 5.0.1'
  s.add_dependency 'elasticsearch-persistence', '~> 5.0', '>= 5.0.1'
  s.add_dependency 'elasticsearch-rails', '~> 5.0', '>= 5.0.1'
